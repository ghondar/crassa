...
function lintClient() {
  ...
  execCmd(
    `npx eslint ${appClient}/**/*.js* --fix --config ${packageRootPath}/.eslintrc`,
    {
      async: true
    }
  );
  execCmd(
    `npx eslint ${appShared}/**/*.js* --fix --config ${packageRootPath}/.eslintrc`,
    {
      async: true
    }
  );
  execCmd(
    `npx stylelint ${appClient}/**/*.css --fix --config ${packageRootPath}/.stylelintrc`,
    {
      async: true
    }
  );
  execCmd(
    `npx stylelint ${appShared}/**/*.css --fix --config ${packageRootPath}/.stylelintrc`,
    {
      async: true
    }
  );
